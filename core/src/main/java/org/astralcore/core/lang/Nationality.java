...
public enum Nationality {
    ...
    Nationality(String country, String nativeName, String flagUnicode) {
    ...
    public static Nationality getNationality(String nationality) {
        for (Nationality N : values()) {
            if (N.toString().equalsIgnoreCase(nationality) || N.country.equalsIgnoreCase(nationality) || N.nativeName.equalsIgnoreCase(nationality)) {
                return N;
            }
        }
