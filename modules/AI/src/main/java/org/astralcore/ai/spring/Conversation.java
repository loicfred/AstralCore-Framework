...
public class Conversation {
    ...
    protected Conversation(String myName, SystemMessage systemMessage) {
    ...
    public String talk(String yourMessage, Object... toolsObjects) {
        return chat(yourMessage, toolsObjects, aiService.Conversationist);
    }
    public String askForInformation(String yourMessage, Object... toolsObjects) {
        return chat(yourMessage, toolsObjects, aiService.Informationist);
    }
    public String askToChooseBetweenItems(String yourMessage, Object... toolsObjects) {
